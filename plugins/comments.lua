...
[[
select left(b_date, 4) y, substring(b_date, 6, 2) m, rows from content_stream where content_ts is not null and content_code='stat_comments'
...
local function personalize(sestb, data)
    ...
    p.types = core.reduce(data.types, 'comment_type_id', x.t)
