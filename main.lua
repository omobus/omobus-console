...
local function startup_script(lang, sestb, usertb, modstb, dumpstb, res, plug_data)
    local ar = {}
    table.insert(ar, "G.setsid('" .. sestb.sid .. "');")
    table.insert(ar, "G.setsprefix('" .. V.static_prefix .. "');")
...
local function default_page(lang, sestb, params, res, plug_data)
    ...
    table.insert(ar, '<script src="' .. V.static_prefix .. '/libs/spin-2.3.2.js"> </script>')
    table.insert(ar, '<script src="' .. V.static_prefix .. '/libs/json-1.0.0.js"> </script>')
    ...
    table.insert(ar, '<td><span class="logotitle">' .. config.title .. '&nbsp;</span><span class="logosubtitle">' .. config.subtitle .. '</span></td>')
    ...
    table.insert(ar, '&nbsp;|&nbsp;')
    table.insert(ar, '<a id="logout" href="' .. REF("/logout") .. '?sid=' .. sestb.sid .. '" class="a_critical">&nbsp;-&nbsp;</a>')
    table.insert(ar, '</div>')
    table.insert(ar, '</td>')
