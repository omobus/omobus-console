...
M.selectable = {
	...
	monthly = {"joint_routes", "confirmations", "orders", "reclamations", "comments", "photos", "testings", "trainings", "presentations", "audits", "shelfs", "quests", "stocks", "advt", "prices", "posms", "promos"}
    },
...
M.permissions.info_materials.add.max_file_size_mb = 45
M.permissions.info_materials.add.depth = 24
