...
var lang = {
	...
	canceling: "Отмена рабочего дня (маршрута)",
    ...
    exit: "Выход",
    export: { 
	photo: "Загрузить фото", progress: "Загружено {0} из {1}",
	xlsx: "Экспорт данных"
    },
...
// *** cancellations journal ***
	cancellations: {
	    title: "Отмененные рабочие дни (маршруты)",
	    //hint: "Журнал отмененных маршрутов.",
	    title1: "Отмененные рабочие дни (маршруты) за",
