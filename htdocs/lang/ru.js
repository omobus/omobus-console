...
var lang = {
    ...
    archive: "<div><b>АРХИВНЫЕ ДАННЫЕ</b></div><div>Отчеты предоставляющие доступ к данным, размещенным в специализированном архивном хранилище OMOBUS.</div>",
    area: "Территория",
    ...
    cash_registers: "Количество касс",
    ...
    confirmations: {
	title: "Журнал подтверждений (задач)",
	title1: "Журнал подтверждений за",
	...
	adjustment: "Корректировка заказанной продукции",
	advt: "Наличие рекламных материалов",
	audit: "Аудит размещения продукции",
	canceling: "Отмена маршрута",
	checkup: "Осмотр торгового зала",
	comment: "Комментарий",
	conference: "Регистрация конференции",
	...
	extra: "Доля дополнительных мест",
	...
	presentation: "Презентация конечным потребителям",
	price: "Мониторинг цен",
	profile: "Редактирование профиля клиента",
	pt: "Фотография ценника",
	rating: "Оценка работы сотрудника",
	receipt: "Приходный кассовый ордер",
	...
	target: "Новая задача",
	testing: "Тестирование контакта (персонала клиента)",
	...
	limited: "В данном разделе приводятся снимки информации в формате CSV в кодировке UTF-8 (дампы) за {0}-дневный период хранения данных в системе OMOBUS. Информация обновляется не менее четырех раза в сутки. Открыть дампы в Microsoft Excel можно с помощью <a target='_blank' href='https://support.office.com/ru-ru/article/%D0%9C%D0%B0%D1%81%D1%82%D0%B5%D1%80-%D0%B8%D0%BC%D0%BF%D0%BE%D1%80%D1%82%D0%B0-%D1%82%D0%B5%D0%BA%D1%81%D1%82%D0%B0-c5b02af6-fda1-4440-899f-f78bafe41857'>мастера импорта текста</a>."
    },
    ...
    exit: "Выход",
    export: { csv: "Экспорт в CSV", photo: "Загрузить фото", progress: "Загружено {0} из {1}" },
    failure: "<< ОШИБКА ЗАГРУЗКИ ДАННЫХ >>",
    fix_dt: "Дата фиксации на устройстве",
	...
	target: "Задача начинает действовать с теущего дня. Продолжительность действия задачи рассчитывается автоматически в момент регистрации задачи. Обратите особое внимание на то, что название и описание должны однозначно идентифицировать задачу.",
    ...
    presentations: {
	title: "Перзентации конечным потребителям",
	title1: "Перзентации конечным потребителям за"
    },
    price: "Цена",
    prices: {
	...
	title1: "Журнал возвратов за",
	caption: "Возврат №{0} / {1}"
    },
    refresh: "обновить",
    reject: { ref: "Отклонить", cap: "Отклонено", mark: "&#x2715;" },
    reports: {
    ...
    testings: {
	title: "Тестирование контакта (персонала клиента)",
	title1: "Тестирование контакта (персонала клиента) за"
    },
    ...
    validate: { ref: "Подтвердить", cap: "Подтверждено", mark: "+" },
    ...
    wishes: {
	title: "Заявки на внесение клиента в маршрут",
	type: "Периодичность"
    },
...
//usercode: "№ маршрута: {0}, код: {1} [{2}].",
	...
	restore: { ref: "Восстановить" },
	remove: { ref: "Удалить", cap: "Удалено" },
...
// *** PLUGINS SPECEFIC STRINGS:


// *** cancellations journal ***
	cancellations: {
	    title: "Отмененные маршруты",
	    //hint: "Журнал отмененных маршрутов.",
	    title1: "Отмененные маршруты за",
	    title2: "Отмена маршрута",
	    type: "Причина отмены",
	    msg0: "Сотрудник не задан. Определите сотрудника, для которого осуществляется отмена маршрута.",
	    msg1: "Неверная дата отмены маршрута. Дата начала отмены не должна быть больше даты окончания отмены.",
	    msg2: "Причина отмены не задана. Выберите причину отмены маршрута.",
msg3: "Ошибка выполнения запроса на сервере.",
	    notice: "Обратите внимание на то, что отмена маршрута автоматичски аннулируется в случае выполнения планового маршрута."
	},
...
// *** deletions journal ***
	deletions: {
	    title: "Закрытые торговые точки",
	    //hint: "Журнал запросов на удаление закрытых или несуществующих торговых точек."
	},

// *** discards journal ***
	discards: {
	    title: "Исключенные из маршрута",
	    //hint: "Журнал запросов на исключение торговых точек из маршрута.",
	    type: "Причина"
	},

// *** info_materials managment subsystem ***
	info_materials: {
	    title: "Информационные материалы",
	    //hint: "Справочник информационных материалов в формате PDF или MP4.",
	    caption0: "Новый информационный материал",
	    caption1: "Редактирование информационного материала #{0}",
	    add: "Добавить материал",
	    blob: "Размер данных, КБ",
	    msg0: "Загрузка файла [{0}] <i>отклонена</i>! Поддерживаются только файлы в формате PDF или MP4.",
	    ...
	    msg3: "Дата начала действия не должна превышать дату окончания действия информационного материала.",
msg4: "Ошибка выполнения запроса на сервере.",
...
// *** planograms managment subsystem ***
	planograms: {
	    title: "Планограммы",
	    //hint: "Справочник планограмм выкладки продукции в формате JPEG.",
	    caption0: "Новая планограмма",
	    caption1: "Редактирование планограммы #{0}",
	    add: "Добавить планограмму",
	    blob: "Размер, КБ",
	    msg0: "Загрузка файла [{0}] <i>отклонена</i>! Поддерживаются только файлы в формате JPEG.",
...
msg3: "Ошибка выполнения запроса на сервере.",
	    notice: "Обратите внимание на то, что название планограммы должно однозначно её идентифицировать, а изображение планограммы должно быть оптимизировано для показа на экране устройства: 1. композиция не должна допускать неиспользуемых полей вокруг основного изображения; 2. размер шрифтов должен быть достаточен для чтения текста на экране устройства; 3. разрешение изображеия не должно превышать максимальное разрешение устройства.",
	    placeholder: "Введите название планограммы"
	},


// *** pos_materials managment subsystem ***
	pos_materials: {
	    title: "POS/POP материалы",
	    //hint: "Справочник POS/POP материалов в формате JPEG.",
	    caption0: "Новый POS/POP материал",
	    caption1: "Редактирование POS/POP материала #{0}",
	    add: "Добавить материал",
	    blob: "Размер, КБ",
	    msg0: "Загрузка файла [{0}] <i>отклонена</i>! Поддерживаются только файлы в формате JPEG.",
...
msg3: "Ошибка выполнения запроса на сервере.",
	    notice: "Обратите внимание на то, что название POS/POP материала должно однозначно идентифицировать данный материал, а изображение POS/POP материала должно быть оптимизировано для показа на экране устройства: 1. композиция не должна допускать неиспользуемых полей вокруг основного изображения; 2. размер шрифтов должен быть достаточен для чтения текста на экране устройства; 3. разрешение изображеия не должно превышать максимальное разрешение устройства.",
...
// *** training_materials managment subsystem ***
	training_materials: {
	    title: "Обучающие материалы",
	    //hint: "Справочник обучающих материалов в формате PDF.",
	    caption0: "Новый обучающий материал",
	    caption1: "Редактирование обучающего материала #{0}",
	    add: "Добавить материал",
	    blob: "Размер PDF, КБ",
	    msg0: "Загрузка файла [{0}] <i>отклонена</i>! Поддерживаются только файлы в формате PDF.",
