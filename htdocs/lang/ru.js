...
var lang = {
    ...
    a_code: "Код клиента",
    a_everything: "Все клиенты",
    a_name: "Клиент",
    account_id: "Уникальный идентификатор клиента",
    abort: "прервать", 
    ...
    alien_data: "Данные получены из внешнего источника",
    altered_data: "Корректировка данных через web-console OMOBUS",
    ...
    founded_data: "Первичное создание данных на устройстве",
	...
	msg0: "Загрузка файла [{0}] <i>отклонена</i>! Поддерживаются только файлы в формате PDF, MP4, JPEG или ZIP.",
    ...
    quests_results: {
	title: "Журнал итогов анкетирования",
	remove: "Удалить ответ на вопрос анкеты (в дальнейшем удаленные данные можно восстановить)",
	restore: "Восстановить ранее удаленный ответ на вопрос анкеты",
	erase_warning: "Очистка данных анкеты приведет к блокировке всех внесенных в анкету ответов на вопросы. Вы уверены, что хотите очистить все внесенные в анкету данные?",
	urgent_warning: "Для устранения выявленных в заполненной анкете проблем, сотруднику требуется повторно посетить клиента. Необходимо в обязательно порядке указать детальную причину срочного посещения (не менее {0} символов)."
    },
	...
	urgent: "Срочное посещение успешно заплпнировано.",
    },
    ...
    urgent: "Требуется срочное посещение",
    urgent_placeholder: "Введите причину срочного посещения",
    username: "Имя пользователя:",
    validity: "Период действия",
    verified_data: "Последнее подтверждение данных на устройстве",
    view: "Посмотреть",
    view_unlinked_data: "Показать удаленные",
    violations: {
	...
	/* -- */
	wday: {
	    begin: "Начало рабочего дня по маршруту позднее {0}",
	    end: "Окончание рабочего дня по маршруту ранее {0}",
	    duration: "Длительность рабочего дня по маршруту менее {0} час."
	},
	timing: "Время проведенное у клиента менее {0} час.",
	power: "Заряд батареи менее {0}%"
    },
    wdays: "Рабочие дни (график работы)",
    wf: "Весовой коэффициент",
    wfAbbr: "В/К", /* weight factor */
    whereis: {
