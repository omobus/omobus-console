...
var PLUG = (function() {
	...
	for( var i = 0; i < size; i++ ) {
		...
		if( (page-1)*perm.rows <= x && x < page*perm.rows ) {
		    ...
		    ar.push("<td class='a_name", r.closed ? " strikethrough attention" : "", r.rejected ? " disabled" : "", "'>", 
			G.shielding(r.a_name), "</td>");
		    ar.push("<td class='a_address note", r.closed ? " strikethrough attention" : "", r.rejected ? " disabled" : "", 
